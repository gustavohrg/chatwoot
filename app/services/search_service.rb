class SearchService
  ...
  def filter_conversations
    conversations_query = conversation_search_scope.joins('INNER JOIN contacts ON conversations.contact_id = contacts.id')
  ...
  def message_base_query
    ...
    query = query.where(conversation_id: permitted_conversations.select(:id)) if restrict_agents_to_assigned_conversations?
    query
  end
  ...
  def conversation_search_scope
    return permitted_conversations if restrict_agents_to_assigned_conversations?
  ...
  def permitted_conversation_ids
    @permitted_conversation_ids ||= permitted_conversations.pluck(:id)
  end
